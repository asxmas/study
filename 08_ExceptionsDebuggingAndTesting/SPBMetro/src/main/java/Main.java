...
public class Main
{
    ...
    private static final Marker CORRECT_STATIONS_MARKER = MarkerManager.getMarker("CORRECT_STATIONS");
    private static final Marker INCORRECT_STATIONS_MARKER = MarkerManager.getMarker("INCORRECT_STATIONS");
    ...
    public static void main(String[] args)
    {
        ...
        for(;;)
        {
            try {
                ...
                logger.error(ERRORS_MARKER,"Возникла ошибка: " + ex.getMessage());
            }
        }
    }
    ...
    private static Station takeStation(String message)
    {
        for(;;)
        {
            ...
            if(station != null) {
                logger.info(CORRECT_STATIONS_MARKER, "Введена станция: " + line);
                return station;

            }
            logger.warn(INCORRECT_STATIONS_MARKER, "Станция " + line + " не найдена.");
            System.out.println("Станция не найдена :(");
            throw new IllegalArgumentException("уупс");
